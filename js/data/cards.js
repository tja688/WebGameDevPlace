...
export const CARD_DEFS = {
    ...
    hone_skill: {
        ...
        growAmount: 1,
        rarity: 'white',
        description: '生长1；驻场：相邻两侧倍率格卡牌点数+3',
        color: '#8B4513',
        accentColor: '#CD853F',
        iconType: 'shield'
    },
    ...
    thirty_hour_training: {
        ...
        keywords: ['stack'],
        rarity: 'blue',
        description: '堆叠；驻场：同倍率格其他卡牌的生长触发两次',
        color: '#1B4F72',
        accentColor: '#5DADE2',
        iconType: 'gear'
    },
    ...
    training_hormone: {
        ...
        keywords: [],
        rarity: 'blue',
        description: '驻场：相邻两侧倍率格卡牌的生长效果触发两次',
        color: '#1B4F72',
        accentColor: '#5DADE2',
        iconType: 'gear'
    },
    ...
    proper_training: {
        ...
        keywords: ['stack'],
        rarity: 'gold',
        description: '堆叠；驻场：本牌所在倍率格的卡牌获得生长2',
        color: '#7D6608',
        accentColor: '#F4D03F',
        iconType: 'star'
    },
    ...
    surging_anger: {
        ...
        keywords: ['stack'],
        rarity: 'white',
        description: '堆叠；驻场：下一张打出在本倍率格上的卡牌点数+4',
        color: '#8B0000',
        accentColor: '#FF4444',
        iconType: 'fire'
    },

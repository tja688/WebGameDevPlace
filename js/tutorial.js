        ...
        steps: [
            {
                title: '欢迎来到烛局原型',
                body: [
                    'Hello！！！欢迎来到游戏：烛局 的原型验证play test，非常感谢游玩，欢迎提出宝贵的意见！',
                    '背景设定：在王国某个偏远的村庄处发生了异变，村民们赖以生存的农田上冒出了地下城，地下城中冒出的白雾包围住村庄，侵蚀着村民的理智与身体，为了不坐以待毙，村民们在优秀的领袖带领下开始推演攻克地下城的办法。目前playtest仅为玩法验证，因此有些虚构成分有对不上的还请谅解。希望你能专注于游戏本身机制上的体验，祝你游玩愉快。'
                ],
                panel: 'center',
                wide: true
            }
    ...
    battle_turn_2: {
        steps: [
            ...
            },
            {
                title: '基础教程结束',
                body: [
                    '教程到此为止，就不多废话了，欢迎通过下方的链接进行反馈，enjoy your game！'
                ],
                targets: ['end_turn'],
                panel: 'center'
            }

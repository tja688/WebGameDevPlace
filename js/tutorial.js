        ...
        steps: [
            {
                title: '欢迎来到烛局原型',
                body: [
                    '欢迎来到《烛局》的玩法验证版本，感谢你愿意试玩。',
                    '王国边境村庄的农田冒出了地下城，白雾侵蚀着村民的理智与身体。为了不坐以待毙，村民们在领袖带领下开始推演攻克地下城的办法。',
                    '当前版本以机制体验为主，部分设定和表现仍在验证中。请重点感受手牌、倍率格、计策和战后成长的组合。'
                ],
                panel: 'center',
                wide: true
            }
        ...
        steps: [
            {
                title: '先看战斗三件事',
                body: [
                    '屏幕下方是手牌，每回合通常抽5张。屏幕中间是倍率格，格内卡牌点数会乘以该格倍率，形成单次打牌的点数。',
                    '屏幕正上方是本关怪物，目标是用本回合伤害压过它的血条。'
                ],
            ...
            },
            {
                title: '血条和怪物技能',
                body: [
                    '只要累计伤害能清空怪物血条，就能赢下这一关。',
                    '但每只怪物会带来不同麻烦。看到不认识的词条时，可以点右上角的书查看说明。'
                ],
                targets: ['monster', 'keyword_book'],
                panel: 'bottom'
            },
            {
                title: '先把五张牌看清楚',
                body: [
                    '前期没有额外抽牌能力时，基本只能利用本回合抽到的手牌。',
                    '观察点数、尺寸和词条后，再决定把牌放进哪个倍率格。'
                ],
                targets: ['hand'],
                panel: 'top'
            },
            {
                title: '计策是打高分的关键',
                body: [
                    '左侧列出了可用的计策阵型。回合结束时，三格堆叠数量命中阵型才会获得倍率加成。',
                    '如果结束回合时没有命中任何计策，就吃不到计策加成。现在试着参照左侧阵型来摆放吧。'
                ],
        ...
        steps: [
            {
                title: '没击败时会被反击',
                body: [
                    '如果上回合伤害没能清空血条，怪物会反击。左上角显示遗物与剩余人群。',
                    '通常每过一回合没击败怪物，就会失去1点人群。请好好利用有限的机会。'
                ],
        ...
        steps: [
            {
                title: '商店用于战后强化',
                body: [
                    '击败普通怪物后通常会进入商店。这里可以买卡、遗物，或使用删牌、数值强化、计策提升和刷新等服务。',
                    '金币有限，优先补足当前牌组最缺的能力，然后点击返回继续进入后续事件。'
                ],
        ...
        steps: [
            {
                title: '事件选择',
                body: [
                    '商店结束后会进入事件选择。事件通常提供免费的成长、资源或特殊机会。',
                    '选择最符合当前牌组方向的一项即可。'
                ],

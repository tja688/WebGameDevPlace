...
| v5.0 | 2026-05-26 | 根据第二版设计落地质检报告全面校准：修复留场生命周期、战斗内永久点数、已在倍率格触发、先手优势、锦上添花、一人成军、遗物实装与每战触发、商店/铁匠/事件/BOSS奖励规则；新增 Playwright 文本状态钩子与 77 项引擎回归断言 |
| v5.2 | 2026-05-26 | 修复教程显示：排查确认教程代码完好，新增 Title 屏幕「重看教程」按钮，方便玩家重置 localStorage 教程标记 |
| v5.3 | 2026-05-26 | 彻底清理旧遗物系统：删除所有不在新设计文档中的遗物（含初始遗物与BOSS遗物），按第二版设计重新落地遗物定义与效果；新增作弊卡支持印卡遗物；修复测试断言匹配留场逻辑 |
| v5.4 | 2026-05-26 | 恢复老兵初始遗物「战场经验」：每场战斗首回合多抽一张牌；职业选择界面显示初始遗物名称 |
| v5.5 | 2026-05-26 | 印卡遗物生成的作弊卡标记为衍生卡（isDerived），战斗结束后自动移除；商店刷新排除作弊卡 |
| v5.6 | 2026-05-26 | 计策面板美化：下移增大、触发时仅高亮名称去掉 bonus 明细、悬停显示计策描述与效果；冒险调试面板改为可收纳默认收起 |
| v5.1 | 2026-05-26 | Bug 同步检查与修复：奉献词条联动遗物生效、留场机制修复（保留原始词条仅生效一回合）、商店去重与价格统一、铁匠移除遗物售卖、铁匠附魔词条本店唯一性、商店/铁匠刷新价格进入时重置、计策等级显示、首回合抽牌遗物叠加、战后清理retainDisabledThisTurn标记 |
